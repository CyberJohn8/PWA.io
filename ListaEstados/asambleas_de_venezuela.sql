...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-12-2024 a las 17:52:40
...
CREATE TABLE `asambleas_de_venezuela` (
  ...
  `Miércoles` varchar(100) NOT NULL,
  `Jueves` varchar(100) NOT NULL,
  `Viernes` varchar(100) NOT NULL,
  `Sábado` varchar(100) NOT NULL,
...
INSERT INTO `asambleas_de_venezuela` (`ID`, `Nombre`, `Numero`, `Estado`, `Direccion`, `Ciudad`, `Domingo`, `Lunes`, `Martes`, `Miércoles`, `Jueves`, `Viernes`, `Sábado`, `Obras`, `GoogleMaps`) VALUES
